...
/____  > \___  >\___  >|__|_ \ \___  >|__|
    ...
    utils.print(f'{G}[>] {C}Seeker by    : {W}dias-2008')
...
def template_select(site):
    ...
    def _copy_if_exists(src, dst):
        ...
        # silently skip if source absent (e.g. captcha template)

    _copy_if_exists('php/error.php',  f'template/{site}/error_handler.php')
    _copy_if_exists('php/info.php',   f'template/{site}/info_handler.php')
    _copy_if_exists('php/result.php', f'template/{site}/result_handler.php')
...
def data_parser():
    ...
    try:
        ...
        var_ip = info_json['ip']
        var_lang = info_json.get('language', 'N/A')
        var_cookies = info_json.get('cookies', 'N/A')
        var_timezone = info_json.get('timezone', 'N/A')
...
{G}[+] {C}Language   : {W}{var_lang}
{G}[+] {C}Cookies    : {W}{var_cookies}
{G}[+] {C}Timezone   : {W}{var_timezone}
